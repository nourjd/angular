...
export const suppliersData: Record<string, any>[] = [
  {
    Id: 1,
    Name: "supplier 1",
    Text: "!youness",
...
export const activityData: Record<string, any>[] = [
  {
    ...
    Message: "Dr.Dali bouzguenda, Cardiologist",
    Time: "5 mins ago",
    Type: "doctor",
  ...
  },
  {
    ...
    Message:
      "Emna chaarana for General Checkup on 7th September, 2021 @ 8.30 AM with Dr.P1",
    Time: "5 mins ago",
    Type: "appointment",
  ...
  },
  {
    ...
    Message: "Eya rayssi for Fever and cold",
    Time: "5 mins ago",
    Type: "patient",
  ...
  },
  {
    Name: "Added New Appointment",
    Message:
      "Siwar dandana for consultation on 7th April, 2022 @ 5.21 AM with Dr.P2",
    Time: "5 mins ago",
    Type: "appointment",
